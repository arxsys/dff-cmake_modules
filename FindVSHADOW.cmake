...
IF (VSHADOW_LIBRARY)
   ...
   IF (VSHADOW_INCLUDE_FILE)
	  IF (CMAKE_GENERATOR MATCHES "Visual Studio")
		...
		STRING(REPLACE "libvsshadow.lib" "" VSHADOW_DYN_LIB_PATH "${VSHADOW_LIBRARY}")
		SET (VSHADOW_DYN_LIBRARIES ${VSHADOW_DYN_LIB_PATH}/libvshadow.dll)
     ...
     IF (UNIX)
	   SET(COMP_VSHADOW_DEF "-DHAVE_STDINT_H -DHAVE_INTTYPES_H -D_LIBVSHADOW_TYPES_H_INTEGERS -DHAVE_WCHAR_H")
	 ENDIF (UNIX)
